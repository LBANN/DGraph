"""
Utilities for distributed training. Copied from:
https://github.com/NERSC/pytorch-examples/blob/main/utils/distributed.py
...
def init_workers_gloo_file():
    ...
    dist.init_process_group(
        backend="gloo", world_size=n_ranks, rank=rank, init_method=sync_file
    )
    return rank, n_ranks
...
def init_workers(backend=None):
    ...
    if backend is None:
        ...
        return init_workers_nccl_slurm()
